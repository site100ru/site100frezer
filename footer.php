        ...
        <div class="row align-items-center">
            <div class="col-xl-2">
                <a href="<?php echo home_url(); ?>">
                    <img id="navbar-brand-img"
                        src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-light.svg" class="img-fluid" />
                </a>
            </div>
            <div class="col-xl-8">
            ...
            <div class="col py-4 d-flex justify-content-center align-items-center">
                <ul class="nav footer-nav align-items-center">
                    <li class="nav-item me-3">
                        <div class="nav-link d-flex align-items-center gap-3 lh-1 nav-link-text"
                    ...
                    <li class="nav-item me-3">
                        <a class="nav-link d-flex align-items-center gap-3 lh-1" href="mailto:zakaz@mglight.ru">
        ...
        <div class="row">
            <div class="col py-5">
                ...
                <ul class="ps-0 pt-5 pt-md-3 pb-2 navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="mailto:zakaz@mglight.ru" class="nav-link ps-0 py-2 footer-mail">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/ico/email-ico.svg"
                                class="me-2" />
                            zakaz@mglight.ru
                        </a>
            ...
            <div class="row">
                <div class="col text-start text-md-center">
                    <div id="im-in-footer">
                        ...
                        <a href="https://site100.ru" class="text-light">site<span
                                style="color: var(--color-accent)">100</span>.ru</a>
                    </div>
                    <div class="policy-in-footer">
                        <a href="<?php echo get_template_directory_uri(); ?>/docs/Privacy-Policy.pdf"
                            target="_blank">Политика конфиденциальности</a>
                        |
                        <a href="<?php echo get_template_directory_uri(); ?>/docs/Consent-to-the-processing-of-personal-data.pdf"
        ...
        <form method="post" action="mails/callback-mail.php" class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <p>
                            <small>Мы свяжемся с Вами в ближайшее время и ответим на все
        ...
        <form method="post" action="<?php echo get_template_directory_uri(); ?>/mails/get_calculate.php"
            ...
            <div class="modal-body">
                <div class="row pb-2">
                    <div class="col-12">
                        <p>
                            <small>Опишите задачу своими словами, укажите форму, размеры, материалы и другую
                                информацию</small>
                        </p>
                    </div>
                    ...
                    <div class="col-12">
                        <p>
                            <small>Вы можете прикрепить проект, изображение или схематично
